	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				next     : '<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span>&raquo;</span></a>',
				prev     : '<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span>&laquo;</span></a>'
			},
